...
namespace ManageEmployees.Migrations
{
    ...
    [Migration("20180527142754_Inicial")]
            ...
            modelBuilder.Entity("ManageEmployees.Models.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 5, 27, 11, 27, 53, 799, DateTimeKind.Local));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 5, 27, 11, 27, 53, 798, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ManageEmployees.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("BirthDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 5, 27, 11, 27, 53, 725, DateTimeKind.Local));
